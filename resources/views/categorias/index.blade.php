                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">Máximo de Horas</th>
                            ...
                            @foreach ($categorias as $categoria)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4 text-gray-900 dark:text-gray-100">{{ $categoria->maximo_horas }}</td>
                                    <td class="px-6 py-4 text-gray-900 dark:text-gray-100">{{ $categoria->curso->nome ?? 'Não informado' }}</td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <form action="{{ route('categorias.destroy', $categoria->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Tem certeza que deseja remover esta categoria?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
